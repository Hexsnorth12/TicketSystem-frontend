        ...
        <div className="relative h-[312px] w-full md:h-[600px]">
            {movies.map((movie, index) => {
                return (
                    <>
                        <div
                            className="absolute inset-0 bg-cover bg-center blur-lg md:h-full md:w-full "
                            style={{
                        ...
                        <div className="relative z-10 grid h-full grid-flow-col grid-rows-6 content-center gap-4">
                                ...
                                <div className="flex">
                                    <div className={bellota.className}>
                                        <div className="flex items-center justify-center gap-x-2 text-center">
                                            <span className="leading-1.5 text-number4 font-bold text-white">
                                                NT$
                                            </span>
                            ...
                            <div className="col-span-2 row-span-1">
                                <div className="text-small1 text-white">
                                    商品規格
                                </div>
